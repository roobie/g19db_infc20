...
The table Students is of course the crème de la crème of all modules because everything is connected to the students in some way. All students have a social security number and this is always unique ant therefore it’s a perfect candidate to be a primary key in our table.<br /><br />

The student table has connections from either the hasstudied or studies depending of the student’s current situation. This allows us to easily find out if a student is currently attending courses as well as a detailed history about past students. The history is also necessary to find out the grades of the students’ in certain courses.<br /><br />

Student section is the table that lists all sections a student has been assigned to. It saves all the points for the specific sections as well as the grades. A section belongs to a course and <br /><br />
